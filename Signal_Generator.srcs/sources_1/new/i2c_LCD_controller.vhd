...
begin
    ...
    begin
         case bytecount is
            ...
            -- First line
            when 8 =>
                data <= top(127 downto 120);
                rs_pre <= '1';
            when 9 =>
                data <= top(119 downto 112);
                rs_pre <= '1';
            when 10 =>
                data <= top(111 downto 104);
                rs_pre <= '1';
            when 11 =>
                data <= top(103 downto 96);
                rs_pre <= '1';
            when 12 =>
                data <= top(95 downto 88);
                rs_pre <= '1';
            when 13 =>
                data <= top(87 downto 80);
                rs_pre <= '1';
            when 14 =>
                data <= top(79 downto 72);
                rs_pre <= '1';
            when 15 =>
                data <= top(71 downto 64);
                rs_pre <= '1';
            when 16 =>
                data <= top(63 downto 56);
                rs_pre <= '1';
            when 17 =>
                data <= top(55 downto 48);
                rs_pre <= '1';
            when 18 =>
                data <= top(47 downto 40);
                rs_pre <= '1';
            when 19 =>
                data <= top(39 downto 32);
                rs_pre <= '1';
            when 20 =>
                data <= top(31 downto 24);
                rs_pre <= '1';
            when 21 =>
                data <= top(23 downto 16);
                rs_pre <= '1';
            when 22 =>
                data <= top(15 downto 8);
                rs_pre <= '1';
            when 23 =>
                data <= top(7 downto 0);
                rs_pre <= '1';
            ...
            when 24 =>
                ...
                rs_pre <= '0';
            when 25 =>
                data <= bot(127 downto 120);
                rs_pre <= '1';
            when 26 =>
                data <= bot(119 downto 112);
                rs_pre <= '1';
            when 27 =>
                data <= bot(111 downto 104);
                rs_pre <= '1';
            when 28 =>
                data <= bot(103 downto 96);
                rs_pre <= '1';
            when 29 =>
                data <= bot(95 downto 88);
                rs_pre <= '1';
            when 30 =>
                data <= bot(87 downto 80);
                rs_pre <= '1';
            when 31 =>
                data <= bot(79 downto 72);
                rs_pre <= '1';
            when 32 =>
                data <= bot(71 downto 64);
                rs_pre <= '1';
            when 33 =>
                data <= bot(63 downto 56);
                rs_pre <= '1';
            when 34 =>
                data <= bot(55 downto 48);
                rs_pre <= '1';
            when 35 =>
                data <= bot(47 downto 40);
                rs_pre <= '1';
            when 36 =>
                data <= bot(39 downto 32);
                rs_pre <= '1';
            when 37 =>
                data <= bot(31 downto 24);
                rs_pre <= '1';
            when 38 =>
                data <= bot(23 downto 16);
                rs_pre <= '1';
            when 39 =>
                data <= bot(15 downto 8);
                rs_pre <= '1';
            when 40 =>
                data <= bot(7 downto 0);
                rs_pre <= '1';
