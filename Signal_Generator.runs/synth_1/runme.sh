...
HD_PWD='C:/Users/schumae/Documents/EE316_Signal_Generator_ZynqBerry/Signal_Generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_user_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_user_logic.tcl
